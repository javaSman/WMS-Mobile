<template>
  ...
  />
  <UserAuth v-model:visible="userAuthVisible" v-model:extra="extraParams" @comfir="comfirAuthCompleted" />
</template>
...
const comfirAuthCompleted = (val: ExtraProps) => {
  // 构造参数,循环混入额外参数
