 ...
 * @returns 订单-？
 */
export function formatEbeln(data: any) {
 ...
 * @returns 去零物料号
 */
export function formatMatnr(data: any, val: number) {
 ...
 * @returns 去零物料号
 */
export function formatMaterial(data: any) {
  let { matnr, idnrk } = data
  let _val = matnr || idnrk
  return (_val as string).replace(/^0+/gi, '')
  // return Number(_val) + ''
}
/**
 * 格式化数量
 ...
 * @returns 数量 | 单位
 */
export function formatErfmg(data: any, val: number) {
  return `${val || ''} ${data.erfme || ''}`
}
/**
 * 格式化数量，乘数
 */
export function formatErfmgMultiple(data: any, val: number) {
  if (!val) return ''
 ...
 * @returns 生产批 / 工位
 */
export function formatCharg(data: any) {
 ...
 * @returns 生产批 | 工位
 */
export function formatProdbatch(data: any) {
 ...
 * @returns 生产批/工位
 */
export function formatProdbatchBySlash(data: any) {
  if (!data.prodbatch && !data.workp) return ''
  return `${data.prodbatch || ''}/${data.workp || ''}`
}
/**
 ...
 * @returns 工厂 | 库位
 */
export function formatLgort(data: any) {
 ...
 * @returns 工厂-库位
 */
export function formatLgortConnector(data: any) {
  if (!data.werks && !data.lgort) return ''
  return `${data.werks || ''}-${data.lgort || ''}`
}
 ...
 * @returns 工厂 | 库位
 */
export function formatLgott(data: any) {
 ...
 * @returns 工厂-库位
 */
export function formatLgottConnector(data: any) {
  if (!data.werks && !data.lgott) return ''
  return `${data.werks || ''}-${data.lgott || ''}`
}
//  【成本中心】数据格式化
export function formatWorkCenter(data: any) {
