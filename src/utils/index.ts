 ...
 * @returns {string}
 */
export function formatTime(time: number, format: string | null = null) {
  if (('' + time).length === 10) {
 ...
 * @param name 参数名
 */
export function getParamsNameValue(name: string) {
...
// 下载文件-已修改
export function downloadFile(obj: any, name: string, suffix = '') {
