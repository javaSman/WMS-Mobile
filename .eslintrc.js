module.exports = {
  ...
  parserOptions: {
    ...
    parser: '@typescript-eslint/parser', // 此项是用来指定eslint解析器的，解析器必须符合规则，babel-eslint解析器是对babel解析器的包装使其与ESLint解析
    parserOptions: {
      parser: 'babel-eslint'
    },
  ...
  rules: {
    ...
    'no-spaced-func': 0, // 函数调用时 函数名与()之间不能有空格,(这里关闭这个功能，因为它和prttierr互相冲突)
    ...
    // '@typescript-eslint/no-unused-vars': 'error', // 检测未使用的变量，函数和函数的参数
    '@typescript-eslint/no-non-null-assertion': 'off', // 允许非空断言
    '@typescript-eslint/no-namespace': 'off', // 允许自定义模块和命名空间
    '@typescript-eslint/no-this-alias': 'off', // 允许对this设置alias
    '@typescript-eslint/no-explicit-any': ['off'], // 允许使用any类型
    '@typescript-eslint/no-var-requires': 'off',
    '@typescript-eslint/no-inferrable-types': 'off' // 去除ts类型检测
  },
  // 引入全局变量
  globals: {
    // 设置只读，不允许更改
